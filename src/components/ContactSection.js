    ...
    <div className="contact-container" id="contact">
      <FadeInSection delay={500}>
        <div className="contact-card">
          <h1 id="contact-title">Want to learn more?</h1>
          <div className="contact-wrapper">
            ...
            <FadeInSection delay={3500}>
              <div className="social">
                <h3 className="contact-section-header">...or connect with me on social!</h3>
                <nav id="social-links">
